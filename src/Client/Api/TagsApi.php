...
class TagsApi
{
    ...
    public function createTagWithHttpInfo($create_tag_request = null, string $contentType = self::contentTypes['createTag'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostPuma\Client\Model\Tag' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostPuma\Client\Model\Tag' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostPuma\Client\Model\Tag', []),
    ...
    public function listTagsWithHttpInfo(string $contentType = self::contentTypes['listTags'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostPuma\Client\Model\ListTags200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostPuma\Client\Model\ListTags200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostPuma\Client\Model\ListTags200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PostPuma\Client\Model\ListTags200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
