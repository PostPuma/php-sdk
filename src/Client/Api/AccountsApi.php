...
class AccountsApi
{
    ...
    public function getAccountWithHttpInfo($account_uuid, string $contentType = self::contentTypes['getAccount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostPuma\Client\Model\Account' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostPuma\Client\Model\Account' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostPuma\Client\Model\Account', []),
    ...
    public function listAccountsWithHttpInfo(string $contentType = self::contentTypes['listAccounts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PostPuma\Client\Model\ListAccounts200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\PostPuma\Client\Model\ListAccounts200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PostPuma\Client\Model\ListAccounts200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PostPuma\Client\Model\ListAccounts200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
